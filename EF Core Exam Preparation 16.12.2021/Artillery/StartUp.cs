namespace Artillery
{
    ...
    public class StartUp
    {
        ...
        {
            var importCountries =
              Deserializer.ImportCountries(context,
            ...
            var importManufacturers = Deserializer.ImportManufacturers(context,
        ...
        {
            //var exportShells = Serializer.ExportShells(context, 100);
            //Console.WriteLine(exportShells);
            //File.WriteAllText(exportDir + "Actual Result - ExportShells.json", exportShells);

            var exportActors = Serializer.ExportGuns(context, "Krupp");
